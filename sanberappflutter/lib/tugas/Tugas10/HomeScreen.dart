      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Image.asset("assets/img/shopee.png", height: 20, width: 20),
              SizedBox(
                height: 16,
              ),
              Text(
        ...
        Container(
          ...
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Image.asset("assets/img/bukalapak.png", height: 20, width: 20),
              SizedBox(
                height: 16,
              ),
              Text(
        ...
        Container(
          ...
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Image.asset("assets/img/blibli.png", height: 20, width: 20),
              SizedBox(
                height: 16,
              ),
              Text(
